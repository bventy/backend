...
- **Documentation**: New features must include appropriate updates to the documentation structure.
- **Go Idioms**: Follow standard Go formatting (`gofmt`) and idiomatic patterns.
